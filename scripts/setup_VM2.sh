...
# Define VM parameters. Was using 2048 for memory and 6 for disk_size but increased it on 1/14/2024
vm_name="in16vm05"
memory=4096
cpus=2
disk_size=12
...
--location "$location" \
--extra-args 'console=ttyS0 ks=http://172.16.0.16:8000/anaconda-ks.cfg'
